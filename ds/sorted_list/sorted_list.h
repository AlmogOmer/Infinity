...
/* Create new list */
extern sorted_list_t *SortedListCreate(is_before_func_t is_before, void *param);
...
sorted_list_iter_t SortedListFindIf(sorted_list_iter_t from, sorted_list_iter_t to, match_func_t is_match, void *param);
